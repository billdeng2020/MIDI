...
void CustomHID_Reset(void)
{
  ...
  SetEPTxCount(ENDP1, userUSB_TXBUF_LENGTH);
  SetEPRxCount(ENDP1, userUSB_RXBUF_LENGTH);
  ...
  SetEPTxCount(ENDP2, userUSB_TXBUF_LENGTH);
  SetEPRxCount(ENDP2, userUSB_RXBUF_LENGTH);
